...
const Testimonial = () => {
  ...
  const renderStars = (count) => {
    return Array.from({ length: 5 }, (_, index) => (
      <svg
        ...
        height="15"
        viewBox="0 0 16 15"
        fill={index < count ? "#5044E5" : "#E5E7EB"}
  ...
  <div className="px-4 sm:px-20 xl:px-32 pt-12 pb-24 bg-white">  
      ...
      <div className="flex flex-wrap justify-center gap-6">
        {testimonials.map((testimonial, index) => (
          <div
            key={index}
            className="p-8 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition duration-300"
          >
