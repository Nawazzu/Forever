...
<div className='flex flex-col sm:flex-row border border-gray-300'>
  {/* Left: Text Section */}
  <div ref={textRef} 
       className='w-full sm:w-1/2 flex items-center justify-center px-6 py-6 sm:py-6 sm:px-12'> {/* Reduced py-12 -> py-6 */}
    <div className='text-[#414141] max-w-xl space-y-4'> {/* Reduced space-y-6 -> space-y-4 */}
      <h1 className='text-3xl md:text-4xl lg:text-5xl font-semibold leading-snug prata-regular'>
        "Bag the Best, <br className='hidden sm:block' /> Focus on What Matters".
      </h1>
